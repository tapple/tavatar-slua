...
# ChatSocket
[ChatSocket](lib/ChatSocket.luau) is a high-level high-speed IO libray for sending data between 2 prims on the same sim, using `ll.RegionSayTo`. It implements flow control, and 3 types of messages:
